            ...
            <div id="home" className="landing-wrapper overflow-hidden">
                <div className="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static">
                    <Link href="/" className="flex align-items-center">
                        ...
                        <span className="text-900 font-medium text-1x1 line-height-1 mr-8">AI Voxa</span>
                    </Link>
                ...
                >
                    <div className="mx-4 md:mx-8 mt-0 md:mt-4">
                        <h1 className="text-6xl font-bold text-primary-900 line-height-2">
                            <span className="text-2xl font-light block">AI Transformation for your customer and business growth</span> Tingkatkan Penjualan &
                            <br />Layanan Pelanggan
                            <br />
                            <span>   dengan AI Agents </span>

                        </h1>
                        <p className="font-normal text-1xl line-height-3 md:mt-3 text-primary-700">
                        Menjawab semua chat dengan cepat, tepat akurat 24/7 dengan AI Chatbot
                    
                         <br/>Promosikan Produk dengan AI Broadcast & Closing lebih efektif dengan AI Followup
                        <br/>
                        

                        {/* <h1 className="text-6xl font-bold text-gray-900 line-height-2">
                            <span className="font-light block">Tingkatkan</span>AI Transformation for 
                            <br />
                            your customer and 
                           <br/>
                        ...
                        Respon cepat otomatis 24/7 dengan AI Chatbot,
                    
                        Promosikan Produk <br/> dengan AI Broadcast &
                        
                        closing lebih efektif dengan AI Followup  */}
                ...
                <div id="features" className="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                    <div className="grid justify-content-center">
                        <div className="col-12 text-center mt-8 mb-4">
                            <h2 className="text-900 font-normal mb-2">Fitur</h2>
                            <span className="text-600 text-2xl">Fitur lengkap untuk melayani pelanggan
                            dengan AI 
                            </span>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900"> AI Chatbot</h5>
                                    <span className="text-600">Ototmatis menjawab semua chat dengan cepat,tepat dan akurat 24/7 gaya bahasa natural.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900"> AI Broadcast </h5>
                                    <span className="text-600">Otomatis broadcast ke banyak pelanggan. Set Schedule Time, Create Template, Campaign & klasifikasi.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">AI Followup</h5>
                                    <span className="text-600">Otomatis kirim pesan tindak lanjut ke pelanggan sesuai konteks chat & Followups leads yg hilang hingga closing.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Learning AI</h5>
                                    <span className="text-600">Cerdas & mudah, AI dapat dilatih dengan gaya bicara sampai info bisnis, sesuai bisnis anda. </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Multi Agent Collaboration</h5>
                                    <span className="text-600">Otomatis assign ke Agent Manusia jika AI tidak dapat menjawab pertanyaan pelanggan. </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Connected Platforms</h5>
                                    <span className="text-600">Menghubungkan berbagai platform, seperti WhatsApp, Instagram, Facebook Messenger, dan Web Live Chat.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Quick Replay</h5>
                                    <span className="text-600">Mempermudah mengirim pesan dengan menyediakan template yang bisa diakses cepat saat percakapan.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">Dashboard & Analytics</h5>
                                    <span className="text-600">Pantau semua chat agent, Jawaban AI dlm 1 dashboard. Ketahui performa agent AI & tim dgn mudah.</span>
                        ...
                        <div className="col-12 md:col-12 lg:col-4 p-0 lg-4 mt-4 lg:mt-0">
                            ...
                            >
                                <div className="p-3 surface-card h-full" style={{ borderRadius: '8px' }}>
                                    ...
                                    <h5 className="mb-2 text-900">System Integrations</h5>
                                    <span className="text-600">Integrasi tool custom dgn database user, seperti alamat, tracking, third-party aplikasi & informasi user lainnya.</span>
                                </div>
                            </div>
                        </div>
                ...
                <div id="pricing" className="py-4 px-4 lg:px-8 my-2 md:my-4">
                    <div className="text-center">
                        <h2 className="text-900 font-normal mb-2"> Pilih Paket </h2>
                        <span className="text-600 text-2xl">AI Tercanggih dengan Harga Terbaik ...</span>
                    </div>
                    ...
                    <div className="grid justify-content-between">
                        <div className="col-12 md:col-2" style={{ marginTop: '-1.5rem' }}>
                            <Link href="/" className="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                                ...
                                <span className="font-medium text-3xl text-900">AIVOX</span>
                            </Link>
                        </div>
